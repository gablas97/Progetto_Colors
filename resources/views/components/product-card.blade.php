...
<div class="group">
    ...
    <div class="relative aspect-square overflow-hidden bg-gray-50">
        ...
        <button
            ...
            <svg class="w-4 h-4 transition-colors {{ $wishlisted ? 'text-red-400' : 'text-gray-400' }}" fill="{{ $wishlisted ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">

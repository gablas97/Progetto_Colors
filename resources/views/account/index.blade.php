...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="border border-gray-200 px-5 py-4 mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="https://search.google.com/local/writereview?placeid={{ config('services.google.place_id') }}"
           ...
           class="btn-primary text-xs self-start sm:flex-shrink-0">
